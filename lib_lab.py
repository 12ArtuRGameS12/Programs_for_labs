T = ((1, 6.314, 12.706, 63.619), (2, 2.92, 4.303, 9.925), (3, 2.353, 3.182, 5.841), (4, 2.132, 2.776, 4.604), (5, 2.015, 2.571, 4.032), (6, 1.943, 2.447, 3.707), (7, 1.895, 2.365, 3.499), (8, 1.86, 2.306, 3.355), (9, 1.833, 2.262, 3.25), (10, 1.812, 2.228, 3.169), (11, 1.796, 2.201, 3.106), (12, 1.782, 2.179, 3.055), (13, 1.771, 2.16, 3.012), (14, 1.761, 2.145, 2.977), (15, 1.753, 2.131, 2.947), (16, 1.746, 2.12, 2.921), (17, 1.74, 2.11, 2.898), (18, 1.734, 2.103, 2.878), (19, 1.729, 2.093, 2.861), (20, 1.725, 2.086, 2.845), (21, 1.721, 2.08, 2.831), (22, 1.717, 2.074, 2.819), (23, 1.714, 2.069, 2.807), (24, 1.711, 2.064, 2.797), (25, 1.708, 2.06, 2.787), (26, 1.706, 2.056, 2.779), (27, 1.703, 2.052, 2.771), (28, 1.701, 2.048, 2.763), (29, 1.699, 2.045, 2.756), (30, 1.697, 2.042, 2.75), (40, 1.684, 2.021, 2.704), (60, 1.671, 2.0, 2.66), (120, 1.658, 1.98, 2.617), (9999, 1.645, 1.96, 2.576))


def clr(text: str) -> str:
	"""
	Чистит водимую строку от лишних пробелов,
	меняет запятые на точки, если используется как десятичный знак
	иначе заменяет на пробелы
	"""
	while text.find("  ") != -1:
		text = text.replace("  ", " ")
	while text.find(" ,") != -1:
...
# a - доверительная вероятность(1=90%, 2=95%, 3=99%); n - число степеней свободы
def stu(n, a=2):
	z = False
	for i in T:
		y = i
